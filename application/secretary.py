...
def show_all_docs_info():
    ...
    result = []
    for current_document in documents:
        current_doc = show_document_info(current_document)
        print(type(current_doc))
        result.append(current_doc)
    return result


def add_new_doc(new_doc_type,
                new_doc_number,
                new_doc_owner_name,
...
def secretary_program_start(user_command = None):
    """
    ...
    while True:
        ...
        if user_command == 'p':
            ...
            new_doc_shelf_number = add_new_doc(new_doc_number,
                                               new_doc_type,
                                               new_doc_owner_name,
                                               new_doc_shelf_number)
